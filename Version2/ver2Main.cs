...
{
    public partial class ver2Main : MetroFramework.Forms.MetroForm
    {
        ...
        public static void CheatEnabled()
        {
            MessageBox.Show(Version2._1.ver2_1Main.EnabledTXT);
        }
        ...
        {
            this.Text = "CoreProject CS:GO v2.0                                                                            " + RandomString(30);
        }
                ...
                while (true)
                {
                    ...
                    if (GameState == 6)
                    {
                        if (HackStats.triggetbot_use)
                        {
                            ...
                            ////int WeaponIndex = CylMem.ReadInt(PlayerBase + Offsets.oMyWP + ((a - 1) * 0x4)) & 0xFFF;
                            ////int CurrWeapEnt = CylMem.ReadInt(clientModule.moduleAddress + Offsets.oEntityList + (WeaponIndex - 1) * 0x10);
                            ////int CurrWeapID = CylMem.ReadInt(CurrWeapEnt + Offsets.aItemDef);
                            //WeaponHandle &= 0xFFF;
                            ...
                            ////Debug.Print(Convert.ToString(CurrWeapID));
