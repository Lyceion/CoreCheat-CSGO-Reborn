...
namespace CoreCheat_Reborn.SDK.Controllers
{
    public static class ClientCMD
    {
        ...
        public static void Exec(string szCmd)
        {
            ...
            IntPtr Thread = CylMem.NativeMethods.CreateRemoteThread(CylMem.ProcessHandle, (IntPtr)null, IntPtr.Zero, new IntPtr(ClientDLLAdress + Offsets.others.dwClientCmd), Address, 0, (IntPtr)null);
